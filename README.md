...
<div class="research-panel" data-panel="select" role="tabpanel">
  <ul class="paper-list">
    ...
    <li>
      ...
      <div class="paper-venues"><span class="venue venue-main">EMNLP 2024</span></div>
    </li>
    <li>
